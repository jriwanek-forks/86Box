...
# Define our flags
string(APPEND CMAKE_C_FLAGS_INIT                " -fomit-frame-pointer -Wall -Wextra -fno-strict-aliasing -Werror=implicit-int -Werror=implicit-function-declaration -Werror=int-conversion -Werror=strict-prototypes -Werror=old-style-definition -Wmaybe-uninitialized -Wstrict-overflow=5")
string(APPEND CMAKE_CXX_FLAGS_INIT              " -fomit-frame-pointer -Wall -Wextra -fno-strict-aliasing  -Wmaybe-uninitialized -Wstrict-overflow=5")
