...
get_axis(JoystickConfiguration &jc, int axis, int joystick_nr)
{
    ...
    int nr_axes  = plat_joystick_state[0][joystick_state[0][joystick_nr].plat_joystick_nr - 1].nr_axes;
...
get_pov(JoystickConfiguration &jc, int pov, int joystick_nr)
{
    ...
    int nr_povs = plat_joystick_state[0][joystick_state[0][joystick_nr].plat_joystick_nr - 1].nr_povs * 2;
