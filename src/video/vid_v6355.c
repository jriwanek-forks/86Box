...
/* Convert attribute byte to CGA colors */
static void
...
void *
v6355_standalone_init(UNUSED(const device_t *info))
{
    int n, c, contrast;
...
device_config_t v6355_config[] = {
    {
        ...
        .selection = {
            { .description = "RGB",             .value = 0}, // DISPLAY_RGB
            {.description = "RGB (no brown)",   .value = 2}, // DISPLAY_RGB_NO_BROWN
            {.description = "Truecolour",       .value = 6}, // DISPLAY_TRUECOLOR
            {.description = "Green Monochrome", .value = 3}, // DISPLAY_GREEN
            {.description = "Amber Monochrome", .value = 4}, // DISPLAY_AMBER
            {.description = "White Monochrome", .value = 5}, // DISPLAY_WHITE
            {.description = "Composite",        .value = 1}, // DISPLAY_COMPOSITE
            {.description = ""                            }
        },
        .default_int = 0
    },
