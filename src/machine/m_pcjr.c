...
machine_pcjr_init(UNUSED(const machine_t *model))
{
    ...
    pcjr_vid = malloc(sizeof(pcjr_vid_t));
    memset(pcjr_vid, 0x00, sizeof(pcjr_vid_t));
    pcjr_kbd = malloc(sizeof(pcjr_kbd_t));
    memset(pcjr_kbd, 0x00, sizeof(pcjr_kbd_t));
    ...
    io_sethandler(0x0060, 4,
                  pcjr_kbd_read, NULL, NULL, pcjr_kbd_write, NULL, NULL, pcjr_kbd);
