...
static const device_config_t sb_live_config[] = {
    {
        ...
        .spinner        = { 0 },
        .selection      = {
          { .description = "CT4620 (Creative CT1297)",   .value = SB_LIVE_CT4620 },
          { .description = "CT4670 (Creative CT1297)",   .value = SB_LIVE_CT4670 },
          { .description = "CT4760 (SigmaTel STAC9721)", .value = SB_LIVE_CT4760 },
          { .description = "CT4780 (Crystal CS4297A)",   .value = SB_LIVE_CT4780 },
          { .description = "SB0060 (SigmaTel STAC9708)", .value = SB_LIVE_SB0060 },
          { .description = "SB0220 (SigmaTel STAC9708)", .value = SB_LIVE_SB0220 },
          { .description = ""                                                    }
        }
    },
    {
