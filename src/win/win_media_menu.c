...
{
    if ((cdrom[i].bus_type == CDROM_BUS_ATAPI) && !MACHINE_HAS_IDE && memcmp(hdc_get_internal_name(hdc_current[0]), "xtide", 5) && memcmp(hdc_get_internal_name(hdc_current[0]), "ide", 3))
        return 0;
...
is_valid_zip(int i)
{
    if ((zip_drives[i].bus_type == ZIP_BUS_ATAPI) && !MACHINE_HAS_IDE && memcmp(hdc_get_internal_name(hdc_current[0]), "xtide", 5) && memcmp(hdc_get_internal_name(hdc_current[0]), "ide", 3))
        return 0;
...
is_valid_mo(int i)
{
    if ((mo_drives[i].bus_type == MO_BUS_ATAPI) && !MACHINE_HAS_IDE && memcmp(hdc_get_internal_name(hdc_current[0]), "xtide", 5) && memcmp(hdc_get_internal_name(hdc_current[0]), "ide", 3))
        return 0;
