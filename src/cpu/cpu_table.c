...
//      {"9.54",    CPU_8088, fpus_8088,  9545456,    1, 5000, 0, 0, 0, 0, 0,0,0,0, 1},
    ...
    .cpus = (const CPU[]) {
        ...
        {"400",       CPU_PENTIUM3,  fpus_internal, 500000000,   3.0, 1475,  0x6B4,  0x6B4, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72}, /* out of spec */
        {"533",       CPU_PENTIUM3,  fpus_internal, 600000000,   6.0, 1475,  0x6B4,  0x6B4, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72}, /* out of spec */
        {"900",       CPU_PENTIUM3,  fpus_internal, 700000000,   7.0, 1475,  0x6B4,  0x6B4, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72}, /* out of spec */
        {"900",       CPU_PENTIUM3,  fpus_internal, 800000000,   8.0, 1475,  0x6B4,  0x6B4, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72}, /* out of spec */
