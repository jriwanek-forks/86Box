...
void v6355_out(uint16_t addr, uint8_t val, void *priv);
uint8_t v6355_in(uint16_t addr, void *priv);
void v6355_write(uint32_t addr, uint8_t val, void *priv);
uint8_t v6355_read(uint32_t addr, void *priv);
