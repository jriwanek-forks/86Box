...
enum {
    ...
    NE2K_RTL8019AS_RSET     = 8, /* 16-bit ISA Jumperless Realtek 8019AS */
    NE2K_RTL8019AS          = 9, /* 16-bit ISA Realtek 8019AS */
    NE2K_DE220P             = 10, /* 16-bit ISA PnP D-Link DE-220P */
    NE2K_RTL8029AS          = 11, /* 32-bit PCI Realtek 8029AS */
