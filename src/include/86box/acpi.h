...
extern void    acpi_set_slot(acpi_t *dev, uint8_t slot);
extern void    acpi_set_irq_mode(acpi_t *dev, uint8_t irq_mode);
extern void    acpi_set_irq_pin(acpi_t *dev, uint8_t irq_pin);
extern void    acpi_set_irq_line(acpi_t *dev, uint8_t irq_line);
